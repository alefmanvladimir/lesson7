...
function dictValueParserAdd(): DictionaryValue<Add> {
 ...
 type OwnableCounter_init_args = {
    $$type: 'OwnableCounter_init_args';
    id: bigint;
}

function initOwnableCounter_init_args(src: OwnableCounter_init_args) {
    return (builder: Builder) => {
        let b_0 = builder;
...
const OwnableCounter_types: ABIType[] = [
...
const OwnableCounter_getters: ABIGetter[] = [
...
const OwnableCounter_receivers: ABIReceiver[] = [
...
export class OwnableCounter implements Contract {
    ...
    static async init(id: bigint) {
        return await OwnableCounter_init(id);
    }
    
    static async fromInit(id: bigint) {
        const init = await OwnableCounter_init(id);
        const address = contractAddress(0, init);
        return new OwnableCounter(address, init);
    }
    ...
    readonly abi: ContractABI = {
        types:  OwnableCounter_types,
        getters: OwnableCounter_getters,
        receivers: OwnableCounter_receivers,
        errors: OwnableCounter_errors,
    };
